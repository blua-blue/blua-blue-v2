<template>
  <section class="container">
    <div class="content">
      ...
      <p>Welcome to blua.blue!</p>

      <p>These terms and conditions outline the rules and regulations for the use of blua.blue's Website,
        located at https://blua.blue.</p>

      <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
        blua.blue if you do not agree to take all of the terms and conditions stated on this page.
      </p>
      ...
      <p>We employ the use of cookies. By accessing blua.blue, you agreed to use cookies in agreement with
        the blua.blue's Privacy Policy.</p>
      ...
      <p>When creating an account you confirm that</p>
      <ul>
        <li>You are at least 13 years of age or of the age legally required to participate in public communication in your country/region</li>
        <li>Your content (articles, posts and comments) does not violate any national (USA) law</li>
      </ul>
      <h3><strong>Fair Usage Agreement</strong></h3>
      <p>Our services include a free API and no hosting fees for your content apply. In the event of strong traffic the following limitations of free usage might come to effect.</p>
      <ul>
      ...
      <p>Unless otherwise stated, blua.blue and/or its licensors own the intellectual property rights for
        all material on blua.blue. All intellectual property rights are reserved. You may access this
        from blua.blue for your own personal use subjected to restrictions set in these terms and
        conditions.</p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from blua.blue</li>
        <li>Sell, rent or sub-license material from blua.blue</li>
        <li>Reproduce, duplicate or copy material from blua.blue</li>
        <li>Redistribute content from blua.blue</li>
      </ul>
      ...
      <p>We will approve link requests from these organizations if we decide that: (a) the link would not
        ...
        hyperlink compensates the absence of blua.blue; and (d) the link is in the context of general
      ...
      <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
        our website, you must inform us by sending an e-mail to blua.blue. Please include your name,
